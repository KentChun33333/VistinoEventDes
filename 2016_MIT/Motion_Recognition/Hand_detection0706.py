...
#    
    ...
    cv2.putText(clone,str(result),(100,100),font,2,(255,255,255),2)
    
    #show height raised fingers
    #cv2.putText(clone,'finger1',tuple(finger[0]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger2',tuple(finger[1]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger3',tuple(finger[2]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger4',tuple(finger[3]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger5',tuple(finger[4]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger6',tuple(finger[5]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger7',tuple(finger[6]),font,2,(255,255,255),2)
    #cv2.putText(clone,'finger8',tuple(finger[7]),font,2,(255,255,255),2)
    #   
