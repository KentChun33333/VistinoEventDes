...
def main_testing_conf():
    ...
    import os
    import imageio
    conf = Conf('conf_hub/conf_depth_L2_finger_1.json')
...
list_dir = os.listdir('/Users/kentchiu/MIT_Vedio/3D_DataSet/L_2_fingers/')[1:]
result_img=[]
for i in range(50,1000):
    a,b = test_with_pro_depth_size(imread('/Users/kentchiu/MIT_Vedio/3D_DataSet/L_2_fingers/'+list_dir[i]),0.45)
    result_img.append(b)



dep_video_saving('conf_depth_L2_finger_1.mp4',6.0,result_img)
